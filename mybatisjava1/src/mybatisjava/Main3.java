...
public class Main3 {
	private final static String NS ="student2."; //final static String NS => 상수
	...
	public  static void main(String[] args) {
		...
		System.out.println("1학년 학생 중 키가 180이상이고, 몸무게가 80이상인 학생의 레코드 조회하기");
		map.clear();
		map.put("height",180);
		map.put("grade",1);
		map.put("weight",80);
